...
const KycProfile: React.FC<KycProfileProps> = ({
  ...
  return (
    <>
      {/* KYC Profile Modal */}
      <div className="fixed inset-0 z-50 flex justify-end items-end sm:items-center bg-black/30 backdrop-blur-sm p-4">
        {/* Clickable backdrop */}
        <div className="absolute inset-0" onClick={onClose}></div>

        {/* Modal Box */}
        <div className="relative bg-white w-full max-w-[675px] h-[90vh] rounded-xl shadow-lg overflow-y-auto z-10">
          {/* Header */}
            ...
            <div className="p-5">
              ...
              <div className="flex mb-6 bg-white border border-[#CDCDCD] rounded-full p-2 w-93">
                <button
                  ...
                  className={`text-sm py-2.5 px-6 cursor-pointer  ${
