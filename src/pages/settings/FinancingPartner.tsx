              ...
              <div className="grid grid-cols-6 gap-1 items-center">
                ...
                <div className="flex items-center space-x-2">
                  <button 
                    ...
                    className="bg-[#273E8E] text-white px-10 py-0.3 rounded-full text-xs font-xs hover:bg-[#1f2f7a] transition-colors"
                  >
                    Edit Category
                  </button>
                  <button 
                    onClick={() => handleDelete(partner.id)}
                    className="bg-[#FF0000] text-white px-4 py-1.5 rounded-full text-xs font-xs hover:bg-[#FF0000] transition-colors"
                  >
                    Delete
                  </button>
                </div>
