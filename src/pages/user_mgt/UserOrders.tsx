...
const userOrdersData = {
  "1": {
    user: { name: "Germandon Abudu", totalOrders: 4, pendingOrders: 1, successfulOrders: 2 },
    orders: [
      { 
        id: 1, 
  ...
  "2": {
    user: { name: "Chiara Lawson", totalOrders: 3, pendingOrders: 0, successfulOrders: 3 },
    orders: [
      { 
        id: 1, 
        orderId: "12ed1mrme4n4bkf", 
  ...
  "3": {
    user: { name: "Anita Becker", totalOrders: 5, pendingOrders: 2, successfulOrders: 2 },
    orders: [
      { 
        id: 1, 
        orderId: "12ed1mrme4n4bkf", 
  ...
  "4": {
    user: { name: "Rasheedat Bello", totalOrders: 6, pendingOrders: 1, successfulOrders: 4 },
    orders: [
      { 
        id: 1, 
        orderId: "12ed1mrme4n4bkf", 
  ...
  "5": {
    user: { name: "Adewale Ade", totalOrders: 2, pendingOrders: 1, successfulOrders: 1 },
    orders: [
      { 
        id: 1, 
        orderId: "12ed1mrme4n4bkf", 
  ...
  "6": {
    user: { name: "Janet Ariel", totalOrders: 3, pendingOrders: 1, successfulOrders: 1 },
    orders: [
      { 
        id: 1, 
        orderId: "12ed1mrme4n4bkf", 
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen">
      ...
      <div className="p-8">
        {/* User Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">{userData.user.name}</h1>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold" style={{color: '#0000FF'}}>{userData.user.totalOrders}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold" style={{color: '#0000FF'}}>{userData.user.pendingOrders}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold" style={{color: '#0000FF'}}>{userData.user.successfulOrders}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <select
                  value={selectedFilter === "Status" ? "Status" : ""}
                  onChange={(e) => setSelectedFilter(e.target.value)}
                  className="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none pr-8"
                >
                  <option value="">Status</option>
                  <option value="Status">order placed</option>
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white">
                {filteredOrders.map((order, index) => (
                  <tr key={order.id} className={`${index !== filteredOrders.length - 1 ? 'border-b border-gray-100' : ''} hover:bg-gray-50`}>
              ...
              <div className="text-center py-4">
                ...
                <p className="text-sm font-medium text-gray-900 mb-1">
                  {selectedOrder.status === "Delivered" ? "Order Delivered" : 
                   selectedOrder.status === "Pending" ? "Order Pending" : "Order Placed"}
                </p>
              ...
              <div>
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <span className="text-lg"><img src="/assets/images/newman1.png" alt={selectedOrder.product} className="w-full h-full object-cover rounded-lg" /></span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <h4 className="text-sm font-medium text-gray-900 truncate">{selectedOrder.product}</h4>
                    <p className="text-lg font-bold text-gray-900">₦{selectedOrder.amount.toLocaleString()}</p>
                    <p className="text-xs text-gray-600">Order Date: {selectedOrder.date}</p>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-green-300 rounded-lg p-3 text-center">
                    <p className="text-xs text-gray-600 mb-2">
                      Installation slot is available for your delivered product. Contact our team to schedule.
                    </p>
              ...
              <div>
                ...
                <div className="space-y-2 text-xs bg-gray-50 rounded-lg p-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900">₦{selectedOrder.amount.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between font-medium">
                    ...
                    <span className="text-blue-600">₦{(selectedOrder.amount + 150000).toLocaleString()}</span>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 bg-gray-50 rounded-lg p-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center mb-1">
                        <span className="text-sm font-medium text-gray-900">{userData.user.name}</span>
                      ...
                      <p className="text-xs text-gray-600">
                        Excellent product quality! The {selectedOrder.product.toLowerCase()} works perfectly and delivery was prompt. Very satisfied with this solar solution.
                      </p>
                    </div>
                  </div>
                </div>
