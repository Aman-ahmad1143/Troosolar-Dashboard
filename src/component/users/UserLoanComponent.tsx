...
const UserLoanComponent: React.FC<UserLoanComponentProps> = ({ user, userLoans }) => {
  ...
  const StatusBadge = ({ status }: { status: "Pending" | "Completed" | "Rejected" }) => {
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen">
      ...
      {showLoanModal && selectedLoan && (
        <div className="fixed inset-0 z-50 flex justify-end items-end">
          ...
          <div className="relative bg-white w-[675px] h-[900px] rounded-xl shadow-lg overflow-y-auto z-10">
            ...
            <div className="flex border-b px-5">
              <button
                className={`py-2 px-0 mr-6 ${activeTab === 'loan' ? 'border-b-2 border-blue-600 font-medium text-blue-900' : 'text-gray-500'}`}
                onClick={() => setActiveTab('loan')}
              >
                Loan Details
              </button>
              <button
                className={`py-2 px-0 ${activeTab === 'financial' ? 'border-b-2 border-blue-600 font-medium text-blue-900' : 'text-gray-500'}`}
            ...
            {activeTab === 'loan' && (
              <div className="px-5">
                <div className="mb-6">
                  ...
                  <div className="space-y-0">
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      ...
                      <span className="font-medium text-sm text-right">{selectedLoan.name}</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Loan Limit</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.loanLimit}</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Loan Amount</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.loanAmount}</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Loan Period</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.loanPeriod}</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Repayment duration</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.repaymentDuration}</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Financing partner</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.financingPartner}</span>
                    </div>
                    <div className="flex justify-between py-3">
                      <span className="text-gray-500 text-sm">Interest rate</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.interestRate}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-0">
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Send Status (to partner)</span>
                      <StatusBadge status={selectedLoan.sendStatus} />
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Send Date</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.sendDate}</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Approval Status (from partner)</span>
                      <StatusBadge status={selectedLoan.approvalStatus} />
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Approval Date</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.approvalDate}</span>
                    </div>
                    <div className="flex justify-between py-3 border-b border-gray-100">
                      <span className="text-gray-500 text-sm">Disbursement Status</span>
                      <StatusBadge status={selectedLoan.disbursementStatus} />
                    </div>
                    <div className="flex justify-between py-3">
                      <span className="text-gray-500 text-sm">Disbursement Date</span>
                      <span className="font-medium text-sm text-right">{selectedLoan.disbursementDate}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-0 border border-gray-100 rounded-md overflow-hidden">
                    <div className="flex justify-between py-3 px-3 border-b border-gray-100">
                      ...
                      <span className="font-medium text-sm text-right">₦2,000,000</span>
                    </div>
                    <div className="flex justify-between py-3 px-3">
                      <span className="text-gray-500 text-sm">Monthly Income</span>
                      <span className="font-medium text-sm text-right">₦200,000</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-0 border border-gray-100 rounded-md overflow-hidden">
                    <div className="flex justify-between py-3 px-3 border-b border-gray-100">
                      ...
                      <span className="font-medium text-sm text-right">Owing 2 institutions</span>
                    </div>
                    <div className="flex justify-between py-3 px-3 border-b border-gray-100">
                    ...
                    <div className="flex justify-between py-3 px-3">
                      ...
                      <span className="font-medium text-sm text-right">₦400,000</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center justify-between py-3 px-3 border border-gray-100 rounded-md">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="text-sm font-medium">Download Account Statement</div>
      ...
      <div className="flex gap-8 border-b border-gray-200 mb-6">
        <button className="pb-2 text-gray-500" onClick={() => navigate(`/user-activity/${user.id}`)}>Activity</button>
        <button className="pb-2 border-b-2 border-blue-900 text-blue-900 font-semibold">Loans</button>
      ...
      <div className="flex flex-wrap gap-6 mb-8">
        <div className="bg-gradient-to-br from-[#2946A9] to-[#f9d423] rounded-2xl shadow-lg p-0 flex items-center justify-center min-w-[350px] min-h-[250px] border-2 border-blue-200" style={{boxShadow: '0 4px 24px 0 rgba(41,70,169,0.10)'}}>
          <div className="w-full h-full flex items-center justify-center">
            <div className="relative w-[400px] h-[320px] flex items-center justify-center">
              <svg width="340" height="300" viewBox="0 0 340 300" style={{ zIndex: 1 }}>
                <defs>
                  <filter id="gauge-shadow" x="-20%" y="-20%" width="140%" height="140%">
                    <feDropShadow dx="0" dy="8" stdDeviation="8" flood-color="#bbb"/>
                  </filter>
                ...
                <ellipse cx="170" cy="170" rx="130" ry="130" fill="#fff" filter="url(#gauge-shadow)" />
                {/* Gauge arc (red to green, thinner, fits inside circle) */}
                <path d="M60,170 A110,110 0 1,1 280,170" fill="none" stroke="url(#gauge-arc)" strokeWidth="10" strokeLinecap="round" />
                {/* Ticks (green, thin) */}
                {Array.from({length: 31}).map((_,i) => {
                  ...
                  return <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="#38a169" strokeWidth="2" />;
                })}
                {/* Needle as triangle */}
                ...
                {/* Centered text */}
                <text x="170" y="210" fontSize="15" fontWeight="500" fill="#888" textAnchor="middle">My Credit Score</text>
                <text x="170" y="250" fontSize="40" fontWeight="bold" fill="#222" textAnchor="middle">0%</text>
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 flex-1 min-w-[250px]">
          <div className="flex gap-6">
            <div className="bg-[#2946A9] text-white rounded-2xl shadow-lg flex-1 p-6 flex flex-col justify-between min-w-[200px]">
              ...
              <div className="bg-[#2946A9]/30 rounded-xl p-4">
                ...
                <div className="text-xl font-semibold mt-1">N500,000<span className="text-lg font-normal">/12months</span></div>
              </div>
            </div>
            <div className="bg-[#2946A9] text-white rounded-2xl shadow-lg flex-1 p-6 flex flex-col justify-between min-w-[200px]">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-red-200" style={{borderColor: "#FFCDD2", borderWidth: "1px", boxShadow: "0px 4px 16px 0px rgba(255,205,210,0.20)"}}>
            <div className="flex items-center justify-between">
              <div className="flex flex-col space-y-2">
                <div className="text-gray-400 text-sm">Next Repayment</div>
                <div className="text-red-500 text-base font-medium">2 days overdue</div>
              </div>
              ...
              <div className="flex flex-col items-end space-y-2">
                <div className="text-blue-900 text-2xl font-bold">N50,000</div>
            ...
            <div ref={sendDropdownRef}>
              ...
              {showSendDropdown && (
                <div className="absolute left-0 mt-1 w-36 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                  <div className="py-1">
                    <button className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100">Pending</button>
                    <button className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100">Completed</button>
                  </div>
                </div>
              )}
            </div>
              ...
              {showApprovalDropdown && (
                <div className="absolute left-0 mt-1 w-36 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                  <div className="py-1">
                    <button className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100">Pending</button>
                    <button className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100">Completed</button>
                    <button className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100">Rejected</button>
                  </div>
                </div>
              )}
            </div>
